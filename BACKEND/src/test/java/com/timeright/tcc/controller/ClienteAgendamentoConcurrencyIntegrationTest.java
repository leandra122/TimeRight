...
class ClienteAgendamentoConcurrencyIntegrationTest {
    ...
    void limpar() {
        ...
        funcionarioServicoRepository.deleteAll();
    ...
    void duasRequisicoesConcorrentesCriamApenasUmaReserva() throws Exception {
        ...
        Usuario cliente = usuario(
                "Cliente concorrente",
                "concorrente@teste.com",
                userRole
        );

        Salao salao = salao();

        Usuario contaFuncionario = usuario(
                "Funcionario",
                "func.concorrente@teste.com",
                employeeRole
        );
        ...
        // Habilita o funcionário para realizar o serviço.
        funcionarioServicoRepository.saveAndFlush(
