...
const CadastroSalao = () => {
  ...
  const [cnpjStatus, setCnpjStatus] = useState('idle'); // idle | consultando | valido | invalido
  ...
  // Dispara consulta quando CNPJ atinge 14 dígitos
  useEffect(() => {
        ...
        <div className="card admin-card">
          <form onSubmit={handleSalvar}>
            <div className="salao-form">
              ...
              {/* CNPJ — campo principal com feedback em tempo real */}
              ...
              {/* Razão social e nome fantasia — preenchidos automaticamente quando disponíveis */}
